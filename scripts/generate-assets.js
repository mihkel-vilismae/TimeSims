 ...
 * script from the repository root via `node scripts/generate-assets.js`.  The
...
// Helper to flatten an array of vec3s into a Float32Array.
...
// Helper to flatten an array of indices into a Uint16Array.
...
// Build a minimal glTF document for a cube scaled and coloured per specification.
...
// Asset definitions: name -> { colour (RGB 0..1), scale [x,y,z] }
const assets = {
